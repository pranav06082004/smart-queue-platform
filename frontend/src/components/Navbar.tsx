...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white shadow px-6 py-3 flex justify-between items-center">
      <Link to="/" className="font-semibold text-slate-900">Smart Queue</Link>

      <div className="flex items-center gap-4 text-sm">
        <Link to="/organizations" className="text-slate-600 hover:text-slate-900">Organizations</Link>
        ...
        {user?.role === "STAFF" && (
          <Link to="/staff/dashboard" className="text-slate-600 hover:text-slate-900">Staff Dashboard</Link>
        )}
